...
client.on("ready", async () => {
  ...
  if (client.guilds.cache.get("1244174322176622604")) {
    if (
      ...
      (
        ...
        .send({ content: "🚀・SZP Community Foi Iniciado!" })
        .catch((error) => {});
    } else {
      console.log("...");
    }
  ...
  const r = new Discord.RichPresence()
    ...
    .setAssetsLargeImage(
      "https://media.discordapp.net/attachments/1244177606535020606/1250173985950269580/SZP_1.png?ex=6669fac1&is=6668a941&hm=5fe5755f97e0266c4bee1f0cca6857c6a1850891cc05fdb14a06fcda8b52358b&=&format=webp&quality=lossless&width=472&height=472",
    )
